...
//        backgroundColor = Color.WHITE; //typedArray.getColor(R.styleable.MaterialBadgeTextView_android_background, Color.WHITE);
//        borderColor = Color.TRANSPARENT; //typedArray.getColor(R.styleable.MaterialBadgeTextView_mbtv_border_color, Color.TRANSPARENT);
//        borderWidth = 0; //typedArray.getDimension(R.styleable.MaterialBadgeTextView_mbtv_border_width, 0);
//        borderAlpha = 1; //typedArray.getFloat(R.styleable.MaterialBadgeTextView_mbtv_border_alpha, 1);
//        ctType = DEFAULT_FILL_TYPE; //typedArray.getInt(R.styleable.MaterialBadgeTextView_mbtv_type, DEFAULT_FILL_TYPE);
//        typedArray.recycle();
    }
